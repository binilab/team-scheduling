...
export function HowItWorks() {
  return (
    <section className="space-y-4">
      <h2 className="text-lg font-semibold text-foreground">어떻게 쓰나요?</h2>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {steps.map((step, index) => (
          <div
            key={index}
            className="relative p-5 bg-card border border-border rounded-xl hover:border-primary/30 transition-colors"
          >
